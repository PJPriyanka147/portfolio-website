...
$(function () {
  $("#about-link").on("click", function () {
    ...
    gsap.to('#scroll-arrow',0,{display:"none"});
    gsap.to('#project',0,{display:"none"});
    gsap.to('#skills',0,{display:"none"});
    gsap.to('#contact',0,{display:"none"});
    gsap.to('#footer',0,{display:"none"});
  ...
  gsap.to('#breaker',0,{display:"none",delay:2});
  gsap.to('#breaker-two',0,{display:"none",delay:2});
  gsap.to('#skills',0,{display:"block",delay:.7});
  gsap.to('#navigation-content',0,{display:'flex',delay:2});
  })
  $("#home-link").on("click", function () {
    ...
    gsap.to('#navigation-content',0,{y:'-100%',delay:.7});
    gsap.to('#header',0,{display:"none"});
  gsap.to('#scroll-arrow',0,{display:"block"});
  gsap.to('#about',0,{display:"block"});
  gsap.to('#project',0,{display:"block"});
  gsap.to('#skills',0,{display:"block"});
  gsap.to('#contact',0,{display:"block"});
  gsap.to('#footer',0,{display:"block"});
  gsap.to('#breaker',0,{display:"block"});
  gsap.to('#breaker-two',0,{display:"block",delay:.1});
  gsap.to('#breaker',0,{display:"none",delay:2});
  gsap.to('#breaker-two',0,{display:"none",delay:2});
